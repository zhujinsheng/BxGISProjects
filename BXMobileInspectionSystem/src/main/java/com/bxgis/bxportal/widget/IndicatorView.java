...
public class IndicatorView extends View {
    ...
    public IndicatorView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            indicatorColor = typedArray.getColor(R.styleable.IndicatorView_indicatorHomeColor, Color.rgb(0, 0, 0));
            indicatorColorSelected = typedArray.getColor(R.styleable.IndicatorView_indicatorHomeColorSelected, Color.rgb(0, 0, 0));
            indicatorWidth = WindowUtils.dip2px(typedArray.getInt(R.styleable.IndicatorView_indicatorWidth, 0));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        /**
         * indicatorCount > 1 表示当只有一页时候指示器就隐藏
         */
        if (indicatorCount > 1) {
