package com.bxgis.bxportal.widget.filterView;
...
public class FilterTreeView extends ViewGroup implements OnItemClickListener {
    ...
    public FilterTreeView(Context context, AttributeSet attrs) {
        ...
        mBorderWidth = WindowUtils.dip2px(1);
    ...
    public void setFilterGroup(FilterGroup group) {
        ...
        if (dividerColor == -1) {
            ...
            mListView.setDividerHeight(WindowUtils.dip2px(1));
        }
    ...
    private void drawBorder(Canvas canvas) {
        ...
        if (child == null) {
            ...
            int shapeHeight = WindowUtils.dip2px(10);
            int shapeWidth =WindowUtils.dip2px(7);
