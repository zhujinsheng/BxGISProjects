package com.bxgis.bxportal.ui.login.presenter;
...
//        }
        ...
        mModel.login(login_name, password).subscribeOn(Schedulers.io()).doOnSubscribe(new Consumer<Disposable>() {
            ...
            public void onNext(@NonNull Response<String> stringResponse) {
                try {
                    // {"msg":"用户合法！","code":2099,"_sso_token":"9cfa41d8-7216-4b57-93a4-bd3096a82f58"}
