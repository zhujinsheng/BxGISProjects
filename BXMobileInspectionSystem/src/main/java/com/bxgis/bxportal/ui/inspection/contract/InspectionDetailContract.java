...
public interface InspectionDetailContract {
    interface Model extends BaseModel {
        Observable<Response<String>> commit(BaseInspection baseInspection, List<File> files,File signatureFile);
    ...
    interface View extends BaseView {
        ...
        void showDetail(List<BaseInspectionSubProject> baseInspections); //返回巡检的项目清单
    ...
    interface Presenter {
        void getReviewInspectionById(String basic_id);
