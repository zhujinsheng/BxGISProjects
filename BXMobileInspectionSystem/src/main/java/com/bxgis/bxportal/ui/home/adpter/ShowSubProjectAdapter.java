...
public class ShowSubProjectAdapter extends RecyclerView.Adapter<ShowSubProjectAdapter.SubProjectAdapterViewHolder> {
    private List<InspectionSubProjectBean> list = new ArrayList<InspectionSubProjectBean>();
    ...
    public ShowSubProjectAdapter(Context context, List<InspectionSubProjectBean> data) {
        this.list = data;
        this.mContext = context;

    }

    public void setData(List<InspectionSubProjectBean> data) {
        this.list = data;
