...
/**
 * Created by xiaozhu on 2018/1/3.
 */

public class CustomJsonCallBack<T> extends AbsCallback<T> {
    private Type type;
    private Class<T> classzz;
//    private KyLoadingBuilder loadingView;

    public CustomJsonCallBack(Class<T> classzz, Activity activity) {
        this.classzz = classzz;
        initLoadingView(activity);
    }

    public CustomJsonCallBack(Type type, Activity activity) {
        this.type = type;
        initLoadingView(activity);
    }
