...
import com.bxgis.yczw.utils.StatusBarUtils;
...
//    }
    ...
    protected void showShortToast(String msg) {
        ToastCompat.makeText(MyApp.getContext(), msg, Toast.LENGTH_SHORT).show();
    }

    protected void showLongToast(String msg) {
        ToastCompat.makeText(MyApp.getContext(), msg, Toast.LENGTH_LONG).show();
    }
